...
os.chdir('D:\\OneDrive\\python\\python_code\\python数据分析\\chapter5')
...
rfm_pd = pd.DataFrame(np.array(rfm_list).T, dtype=np.int32, columns=rfm_cols,
...
gp = rfm_pd.groupby('rfm_comb').count()
